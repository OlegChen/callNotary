...
- (void) viewDidLoad
{
  [super viewDidLoad];
    ...
    if (IS_IPHONE_5) {
        self.tableView = [[[UITableView alloc] initWithFrame:CGRectMake(0, 40, 320, 528)] autorelease];
    }else{
    
    self.tableView = [[[UITableView alloc] initWithFrame:CGRectMake(0, 40, 320, 500)] autorelease];
