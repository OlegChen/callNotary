...
- (void)viewDidLoad
{
    ...
    self.tableView.backgroundColor = [UIColor colorWithRed:236.0f/255.0f green:247.0f/255.0f blue:254.0f/255.0f alpha:255];
...
- (void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    BOOL hasSubTable = NO;
    NSArray * subviews = cell.subTable.subviews;
...
- (void)autoExpanded:(NSIndexPath *)indexPath{
