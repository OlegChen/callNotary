...
- (void) setupInterface
{
    ...
    expandBtn.frame = CGRectMake(10, 20, 25, 25);
    [expandBtn setBackgroundColor:[UIColor clearColor]];
    [expandBtn setImage:[UIImage imageNamed:@"arrow_left"] forState:UIControlStateNormal];
...
//    expandBtn.alpha = 0.45;
    [_btnBig addTarget:self action:@selector(rotateExpandBtn:) forControlEvents:UIControlEventTouchUpInside];
    
    offCheckBox = [[UIImageView alloc] initWithImage: [UIImage imageNamed:@"empty"]];
    onCheckBox = [[UIImageView alloc] initWithImage: [UIImage imageNamed:@"checked"]];
}
...
-(void) rotateExpandBtn:(id)sender
{
    ...
    [_groupCelldelegate notificationExpendButtonClick:self.tag isExpend:isExpanded];
    /*
