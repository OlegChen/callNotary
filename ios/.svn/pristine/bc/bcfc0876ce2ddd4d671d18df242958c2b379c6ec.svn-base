...
@protocol ZSYPopoverListViewDelegate <NSObject>

- (void)returnTheContent:(NSString *)content;

@end
@protocol ZSYTextViewDelegate <NSObject>
...
@interface ZSYPopoverListView : UIView<UITableViewDataSource, UITableViewDelegate,UITextViewDelegate> {

    id<ZSYPopoverListViewDelegate> myDelegate;
...
@property (nonatomic, retain) id <ZSYTextViewDelegate>textviewdatasource;

@property (nonatomic, retain) UILabel *titleName;
@property (nonatomic, retain) UITextView * textView;
@property (nonatomic, retain) id<ZSYPopoverListViewDelegate> myDelegate;
